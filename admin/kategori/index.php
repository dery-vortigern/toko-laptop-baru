...
<div class="container-fluid px-4">
    <div class="page-header">
        <h1 class="mb-2 fw-bold">Data Kategori</h1>
        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <span class="fw-bold">Data Kategori</span>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="#" 
                                       onclick="confirmDelete('hapus.php?id=<?= $row['kategori_id']; ?>', '<?= htmlspecialchars($row['nama_kategori']); ?>')" 
