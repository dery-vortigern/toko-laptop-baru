...
if (isset($_POST['edit'])) {
    ...
    $clean_telepon = preg_replace('/[^0-9]/', '', $telepon);
    
    // Validasi nomor telepon
    if (!preg_match("/^[0-9]{10,15}$/", $clean_telepon)) {
        $error = true;
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3"
                                          placeholder="Masukkan alamat lengkap"><?= htmlspecialchars($supplier['alamat']); ?></textarea>
                            </div>
                            <div class="form-text">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="telepon" name="telepon" 
                                       value="<?= htmlspecialchars($supplier['telepon']); ?>" required>
                            </div>
                            <div class="invalid-feedback">
                                Nomor telepon tidak valid!
                            </div>
                            <div class="form-text">
                                Format: 081234567890 (10-12 digit)
                            </div>
                        </div>
